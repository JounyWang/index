...
function() {
    ...
    function(e, t, n) {
        ...
        c = function() {
            ...
            return l["default"].each(s,
            function(t) {
                if (t.litmus(e)) return l["default"].each(t.conversions,
                function(t, n) {
                    if (u = t.read(e), d === !1 && u !== !1) return d = u,
                    u.conversionName = n,
                    u.conversion = t,
                    l["default"].BREAK
                }),
    ...
    function(e, t) {
        ...
        i = {
            BREAK: {},
            extend: function(e) {
                return this.each(o.call(arguments, 1),
                function(t) {
            ...
            each: function(e, t, o) {
                if (e) if (n && e.forEach && e.forEach === n) e.forEach(t, o);
    ...
    function(e, t, n) {
        ...
        d = {
            ...
            getOffset: function(e) {
                ...
                if (t.offsetParent) do n.left += t.offsetLeft,
                n.top += t.offsetTop,
                t = t.offsetParent;
                while (t);
                return n
    ...
    function(e, t, n) {
        ...
        _ = function(e) {
            function t(n, o, a) {
                ...
                l.updateDisplay(),
                d["default"].bind(l.__select, "change",
                function() {
    ...
    function(e, t, n) {
        ...
        c = function(e) {
            function t(n, o) {
                ...
                d["default"].bind(s.__input, "keydown",
                function(e) {
    ...
    function(e, t, n) {
        ...
        p = function(e) {
            function t(n, o, a) {
                ...
                c["default"].bind(h.__input, "keydown",
                function(e) {
    ...
    function(e, t, n) {
        ...
        c = function(e) {
            function t(n, o, a) {
                ...
                d["default"].bind(l.__button, "click",
                function(e) {
    ...
    function(e, t, n) {
        ...
        function l(e, t, n, o) {
            ...
            g["default"].each(y,
            function(i) {
                e.style.cssText += "background: " + i + "linear-gradient(" + t + ", " + n + " 0%, " + o + " 100%);display:none; "
            })
        }
        function s(e) {
            e.style.background = "",
            e.style.cssText += "background: -moz-linear-gradient(top,  #ff0000 0%, #ff00ff 17%, #0000ff 34%, #00ffff 50%, #00ff00 67%, #ffff00 84%, #ff0000 100%);display:none;",
            e.style.cssText += "background: -webkit-linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);display:none;",
            e.style.cssText += "background: -o-linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);display:none;",
            e.style.cssText += "background: -ms-linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);display:none;",
            e.style.cssText += "background: linear-gradient(top,  #ff0000 0%,#ff00ff 17%,#0000ff 34%,#00ffff 50%,#00ff00 67%,#ffff00 84%,#ff0000 100%);display:none;"
        }
        t.__esModule = !0;
        var u = n(7),
        d = o(u),
        ...
        v = function(e) {
            function t(n, o) {
                ...
                f["default"].bind(v.__input, "keydown",
                function(e) {
                    13 === e.keyCode && d.call(this)
                }),
                f["default"].bind(v.__input, "blur", d),
                f["default"].bind(v.__selector, "mousedown",
                function() {
                    f["default"].addClass(this, "drag").bind(window, "mouseup",
                    function() {
                ...
                f["default"].bind(v.__hue_field, "mousedown",
                function(e) {
                    b(e),
            ...
            t.prototype.updateDisplay = function() {
                ...
                if (e !== !1) {
                    var t = !1;
                    g["default"].each(p["default"].COMPONENTS,
                    function(n) {
    ...
    function(e, t, n) {
        ...
        function a(e, t, n) {
            ...
            function() {
                ...
                U["default"].each(["updateDisplay", "onChange", "onFinishChange", "step"],
                function(t) {
                    var o = n[t],
                    i = e[t];
                    n[t] = e[t] = function() {
            ...
            } else n instanceof O["default"] ? (z["default"].bind(t, "click",
            function() {
                z["default"].fakeEvent(n.__checkbox, "click")
            }), z["default"].bind(n.__checkbox, "click",
            function(e) {
                e.stopPropagation()
            })) : n instanceof R["default"] ? (z["default"].bind(t, "click",
            function() {
                z["default"].fakeEvent(n.__button, "click")
            }), z["default"].bind(t, "mouseover",
            function() {
                z["default"].addClass(n.__button, "hover")
            }), z["default"].bind(t, "mouseout",
            function() {
        ...
        function f(e) {
            ...
            e.load && e.load.remembered ? U["default"].each(e.load.remembered,
            function(t, n) {
                d(e, n, n === e.preset)
            }) : d(e, Q, !1),
            z["default"].bind(a, "change",
            function() {
            ...
            z["default"].bind(l, "keydown",
            function(e) { ! e.metaKey || 67 !== e.which && 67 !== e.keyCode || Z.hide()
            }),
            z["default"].bind(n, "click",
            function() {
            ...
            z["default"].bind(o, "click",
            function() {
                e.save()
            }),
            z["default"].bind(i, "click",
            function() {
                var t = prompt("Enter a new preset name.");
                t && e.saveAs(t)
            }),
            z["default"].bind(r, "click",
            function() {
                e.revert()
            })
        }
        ...
        function h(e, t) {
            var n = {};
            return U["default"].each(e.__rememberedObjects,
            function(o, i) {
                var r = {},
        ...
        function b(e) {
            0 !== e.length && D["default"].call(window,
            function() {
                b(e)
            }),
            U["default"].each(e,
        ...
        oe = function ie(e) {
            ...
            if (Object.defineProperties(this, {
                ...
                z["default"].bind(this.__closeButton, "click",
                function() {
                    n.closed = !n.closed
                })
            } else {
            ...
            o.autoPlace && (U["default"].isUndefined(o.parent) && ($ && (ee = document.createElement("div"), z["default"].addClass(ee, Y), z["default"].addClass(ee, ie.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(ee), $ = !1), ee.appendChild(this.domElement), z["default"].addClass(this.domElement, ie.CLASS_AUTO_PLACE)), this.parent || p(n, o.width)),
        ...
        U["default"].extend(oe.prototype, {
            ...
            onResize: function() {
                ...
                if (e.scrollable) {
                    ...
                    n = 0;
                    U["default"].each(e.__ul.childNodes,
                    function(t) {
            ...
            remember: function() {
                ...
                var e = this;
                U["default"].each(Array.prototype.slice.call(arguments),
                function(t) {
            ...
            getSaveObject: function() {
                ...
                this.__rememberedObjects.length > 0 && (e.preset = this.preset, e.remembered || (e.remembered = {}), e.remembered[this.preset] = h(this)),
                e.folders = {},
                U["default"].each(this.__folders,
                function(t, n) {
            ...
            revert: function(e) {
                U["default"].each(this.__controllers,
                function(t) {
    ...
    function(e, t, n) {
        ...
        u = function() {
            function e() {
                ...
                var t = this;
                a["default"].bind(this.backgroundElement, "click",
                function() {
                    t.hide()
                })
            }
